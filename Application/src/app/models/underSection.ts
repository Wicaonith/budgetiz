 ...
 * 
 * @attribut id - string - L'identifiant de la sous rubrique
...
export class Undersection implements Entity {
     ...
     * 
     * @param id - string - L'identifiant de la sous rubrique
     ...
     */
    constructor(id: string, name: string, section: Section, inTab: boolean) {
        this.id = id;
        this.name = name;
